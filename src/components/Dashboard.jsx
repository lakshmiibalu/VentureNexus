    ...
    <div>
      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          ...
          <Link className="btn btn-success" to='/mentor'>Mentorship</Link>
          ...
          <div className="col-12 d-flex justify-content-center">
            <Link to="/profile" onClick={(e) => { e.preventDefault(); toggleChatbot(); }}>
              <img
                src="https://img.icons8.com/?size=100&id=apeVVtmsp9hB&format=png&color=228BE6"
                alt="My Profile"
                style={{ background: 'white', width: '60px', height: '60px', borderRadius: '50%', marginRight: '10px' }}
              />
            </Link>
        ...
        <div className="container">
          <div className="row">
            <div className="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
              ...
              <p class="card-text"></p>
              <ul>
                <li class="list-group-item  text-white"><img src="https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/75230/location-icon-clipart-xl.png" alt="Bootstrap" width="40" height="30" />&nbsp;</li><br></br>

                <li class="list-group-item  text-white"><img src="https://cdn.pixabay.com/photo/2021/10/29/21/40/phone-icon-6753051_1280.png" alt="Bootstrap" width="40" height="30" />&nbsp;</li><br></br>

                <li class="list-group-item  text-white"><img src="https://cdn4.iconfinder.com/data/icons/social-media-logos-6/512/112-gmail_email_mail-512.png" alt="Bootstrap" width="40" height="30" />&nbsp; </li>

              </ul>
            </div>
            <div className="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
              <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Business Oppurtunities</h5>
              <br></br>

              <ul>
                <a class="nav-link active" aria-current="page" href="#"><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Automotive</font></a><br></br>
                <a class="nav-link" href="#"><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Beauty & Health</font></a><br></br>
                <a class="nav-link" href="#"><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Business Services</font></a><br></br>
                <a class="nav-link" href="#"><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dealers & Distributors</font></a><br></br>
                <a class="nav-link" href="#"><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Education</font></a>
              </ul>
            </div>
            <div className="col col-12 col-sm-6 col-md- col-lg-4 col-xl-4 col-xxl-4">
              <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Follow us on</h5>
              <li class="list-group-item bg-dark text-white"> <Link to=""><img src="https://cdn.pixabay.com/photo/2015/05/17/10/51/facebook-770688_1280.png" alt="Bootstrap" width="40" height="30" /></Link>
                &nbsp;&nbsp;&nbsp;<Link to=""><img src="https://cdn.pixabay.com/photo/2016/09/17/07/03/instagram-1675670_1280.png" alt="Bootstrap" width="40" height="30" /></Link>
                &nbsp;&nbsp;&nbsp;<Link to=""></Link><img src="https://cdn-icons-png.flaticon.com/512/124/124021.png" alt="Bootstrap" width="40" height="40" />
                &nbsp;&nbsp;&nbsp;<Link to=""></Link><img src="https://cdn.pixabay.com/photo/2015/09/14/22/59/google-plus-940316_1280.png" alt="Bootstrap" width="40" height="30" />
              </li>
            </div>
      ...
      {showChatbot && (
        <div className="chatbot-window" style={{
          ...
          backgroundColor: 'white', border: '1px solid #ccc', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)'
        }}>
          <div className="chatbot-header" style={{ padding: '10px', backgroundColor: '#228BE6', color: 'white', borderRadius: '10px 10px 0 0' }}>
            <strong>Chatbot</strong>

            <button onClick={toggleChatbot} className="btn-close" data-bs-dismiss="modal" style={{ float: 'right', background: 'none', border: 'none', color: 'white', cursor: 'pointer' }}>×</button>
          </div>
          <div className="chatbot-body" style={{ padding: '10px', overflowY: 'scroll', height: 'calc(100% - 40px)' }}>
